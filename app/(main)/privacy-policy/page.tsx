        ...
        >
          <motion.section variants={sectionVariants}>
            ...
            <p>
              ...
              (“Company”, “we”, “our”, or
              “us”) collects, uses, and
              protects your personal
              information when you use our
              website and services. By
              accessing our website or using
              our services, you agree to the
          ...
          <motion.section variants={sectionVariants}>
            ...
            <ul className="list-disc ml-6 mt-2 space-y-1">
              ...
              <li>
                To manage client projects and
                communication
              </li>

              <li>
                To send newsletters or
                updates (if subscribed)
              </li>
          ...
          <motion.section variants={sectionVariants}>
            ...
            <p>
              ...
              personal data. However, we may
              share information with trusted
              third parties when necessary
              to operate our services, such
              as hosting providers,
              analytics tools, or marketing
              platforms.
            </p>
          ...
          <motion.section variants={sectionVariants}>
            ...
            <p>
              ...
              to third-party websites or
              services. We are not
              responsible for the privacy
              practices or content of those
              external websites.
            </p>
          </motion.section>
          ...
          <motion.section variants={sectionVariants}>
            ...
            <p>
              ...
              toward individuals under the
              age of 13. We do not knowingly
          ...
          <motion.section variants={sectionVariants}>
            ...
            <p>
              ...
              Changes will be posted on this
              page with an updated revision
              date.
            </p>
          </motion.section>
