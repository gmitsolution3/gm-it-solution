...
import CreateLeadershipMessageModal from "@/components/admin-dashboard/modals/CreateLeadershipMessageModal";
import ViewLeadershipMessageModal from "@/components/admin-dashboard/modals/ViewLeadershipMessageModal";
...
import EditLeadershipMessageModal from "@/components/admin-dashboard/modals/EditLeadershipMessageModal";
import Image from "next/image";

export default function AdminLeadershipMessagesPage() {
  const { data, isLoading, refetch } = useFetch<{
    data: ILeadershipMessage[];
  }>("/leadership-message");
