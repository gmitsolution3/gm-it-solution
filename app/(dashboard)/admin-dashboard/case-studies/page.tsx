...
import CreateCaseStudyModal from "@/components/admin-dashboard/modals/CreateCaseStudyModal";
import EditCaseStudyModal from "@/components/admin-dashboard/modals/EditCaseStudyModal";
import ViewCaseStudyModal from "@/components/admin-dashboard/modals/ViewCaseStudyModal";
...
export default function AdminCaseStudiesPage() {
  ...
  const { mutate: deleteCaseStudy, isLoading: isDeleting } =
    useDelete("/case-studies", {
      revalidateKey: "/case-studies",
    });
