...
const AboutChairmanSectionComponent = ({ leadershipData }: Props) => {
  return (
            ...
            <div className="flex justify-center">
              <div className="relative w-48 h-48 sm:w-56 sm:h-56 md:w-64 md:h-64 lg:w-80 lg:h-80 xl:w-96 xl:h-96">
                <Image
                  ...
                  className="object-cover rounded-full shadow-2xl border-4 border-primary/70 mx-auto hover:scale-105 transition-transform duration-700"
                />
              </div>
            </div>
          </motion.div>
...
export default memo(AboutChairmanSectionComponent);
