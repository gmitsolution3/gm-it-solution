...
import { ArrowRight, Bolt, Mail, MapPin, Phone } from "lucide-react";
            ...
            <div className="space-y-3 sm:space-y-4 text-center lg:text-left">
              ...
              <div className="flex flex-wrap justify-center lg:justify-start gap-3 sm:gap-4 pt-2 sm:pt-3 md:pt-4 px-4 sm:px-6 lg:px-0">
                {[
                  ...
                  <div
                    key={item}
                    className="flex items-center gap-1 sm:gap-2 text-xs sm:text-sm text-muted-foreground bg-background/50 backdrop-blur-sm px-3 py-1.5 rounded-full"
                  >
                ...
                <div className="space-y-1.5 sm:space-y-2">
                  ...
                  <div className="relative group">
                    <input
                      ...
                      className="w-full px-3 sm:px-4 py-3 sm:py-4 rounded-none bg-background border border-border focus:border-primary focus:outline-none focus:ring-2 sm:focus:ring-4 focus:ring-primary/10 transition-all duration-200 text-sm sm:text-base text-foreground placeholder:text-muted-foreground/50 group-hover:border-primary/50"
                    />
            ...
            <div className="flex gap-2 sm:gap-3 justify-center sm:justify-start">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="w-8 h-8 sm:w-9 sm:h-9 md:w-10 md:h-10 rounded-lg bg-muted hover:bg-primary flex items-center justify-center transition-all duration-300"
                >
                  <social.icon />
                </a>
              ))}
