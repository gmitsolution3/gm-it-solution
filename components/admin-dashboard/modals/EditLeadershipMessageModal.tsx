...
interface EditLeadershipMessageModalProps {
  isModalOpen: boolean;
...
export default function EditLeadershipMessageModal({
  isModalOpen,
  setIsModalOpen,
  messageData,
  onSuccess,
}: EditLeadershipMessageModalProps) {
  const { mutate: updateData, isLoading } = usePatch(`/leadership-message`, {
  ...
  useEffect(() => {
    if (messageData && isModalOpen) {
      form.reset({
        ...
        imagePublicId: messageData.imagePublicId || "",
      });
      setActiveTab(
        messageData.role === "chairman" ? "chairman" : "ceo",
      );
        ...
        <div className="w-full">
          ...
          >
            <TabsList className="flex flex-row w-full mb-6">
              <TabsTrigger value="chairman" className="flex-1 text-base">
                <User className="h-4 w-4 mr-2" />
                Chairman
              </TabsTrigger>
              <TabsTrigger value="ceo" className="flex-1 text-base">
                <User className="h-4 w-4 mr-2" />
                CEO
              </TabsTrigger>
            </TabsList>
