...
interface ViewLeadershipMessageModalProps {
  isModalOpen: boolean;
  setIsModalOpen: (open: boolean) => void;
  selectedMessage: ILeadershipMessage | null;
}

export default function ViewLeadershipMessageModal({
  isModalOpen,
  setIsModalOpen,
  selectedMessage,
}: ViewLeadershipMessageModalProps) {
      ...
      <DialogContent className="!max-w-4xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-6">
          ...
          <div className="flex items-center gap-4">
            {/* Profile Image */}
            <div className="flex-shrink-0 w-20 h-20 rounded-full bg-primary/10 flex items-center justify-center overflow-hidden border-2 border-primary/20 relative">
