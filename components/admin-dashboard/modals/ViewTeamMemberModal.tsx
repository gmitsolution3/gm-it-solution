...
export default function ViewTeamMemberModal({
  isModalOpen,
  setIsModalOpen,
  selectedMember,
      ...
      <DialogContent className="!max-w-2xl">
        ...
        <div className="space-y-6">
          ...
          <div className="flex justify-center">
            <div className="w-32 h-32 rounded-full bg-primary/10 flex items-center justify-center overflow-hidden border-4 border-primary/20 relative">
          ...
          {selectedMember.linkedin && (
            <div className="space-y-2">
              ...
              <a
                ...
                className="flex items-center text-blue-600 hover:underline group break-all"
              >
