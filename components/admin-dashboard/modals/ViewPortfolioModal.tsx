// components/admin-dashboard/modals/ViewPortfolioModal.tsx
"use client";
      ...
      <DialogContent className="!max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-6">
          ...
          {selectedPortfolio.image && (
            <div className="rounded-lg overflow-hidden border bg-muted relative h-[300px]">
              <Image
          ...
          {/* Actions */}
          <div className="flex justify-end gap-3 pt-4 py-2">
            <Button
              variant="outline"
