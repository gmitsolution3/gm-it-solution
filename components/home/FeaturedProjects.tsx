...
const FeaturedProjectsComponent = () => {
  ...
  const portfolioList: IPortfolioItem[] =
    data?.data || [];

  const featuredOnly = useMemo(
    () => portfolioList.slice(0, 4),
    [portfolioList],
  );
        ...
        <div className="container mx-auto px-4 lg:px-8 relative z-10">
          ...
          >
            ...
            <p className="text-base text-muted-foreground">
              Explore our recent work and see how
          ...
          >
            ...
            <p className="text-muted-foreground text-center max-w-md mb-8">
              We're currently curating our best
              work. Check back soon to see our
    ...
    <section className="py-24 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        ...
        >
          ...
          <p className="text-base text-muted-foreground">
            Explore our recent work and see how
            we've helped businesses achieve their
            digital goals.
          </p>
        </motion.div>
