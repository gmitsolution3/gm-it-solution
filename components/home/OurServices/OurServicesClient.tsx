      ...
      <div className="container mx-auto px-4 lg:px-8">
        ...
        {services.length === 0 ? (
          ...
          >
            ...
            >
              We're currently updating our service offerings. Check back soon to
                ...
                {services.map((service, index) => (
                  <SwiperSlide key={service._id || index} className="h-auto">
                    <Link href="/services" className="block h-full">
                      ...
                      >
                        {/* Icon */}
                        <div className="relative w-16 h-16 rounded-none bg-gradient-to-br from-primary/10 to-accent/10 flex items-center justify-center mb-6 overflow-hidden">
                          <Image
                            src={service.icon}
                            alt={service.title}
                            fill
              ...
              {services.length > 3 && (
                <>
                  <button
                    ...
                    className="hidden lg:inline-flex absolute -left-10 top-1/2 -translate-y-1/2 z-10 w-10 h-10 bg-background border border-border hover:border-primary/20 rounded-none items-center justify-center hover:bg-primary/5 transition-all -ml-5"
                  ...
                  <button
                    ...
                    className="hidden lg:inline-flex absolute -right-10 top-1/2 -translate-y-1/2 z-10 w-10 h-10 bg-background border border-border hover:border-primary/20 rounded-none items-center justify-center hover:bg-primary/5 transition-all -mr-5"
