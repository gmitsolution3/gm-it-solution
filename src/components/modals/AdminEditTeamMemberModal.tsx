// components/modals/AdminEditTeamMemberModal.tsx
"use client";
...
interface AdminEditTeamMemberModalProps {
  isModalOpen: boolean;
...
export default function AdminEditTeamMemberModal({
  isModalOpen,
  setIsModalOpen,
  memberData,
  onSuccess,
}: AdminEditTeamMemberModalProps) {
  const { mutateAsync: updateData, isPending: isLoading } = usePatch({
    url: `/team-members/${memberData._id}`,
  });
