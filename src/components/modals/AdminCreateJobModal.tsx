// components/modals/AdminCreateJobModal.tsx
"use client";
...
export default function AdminCreateJobModal({
  isModalOpen,
  setIsModalOpen,
  onSuccess,
}: AdminCreateJobModalProps) {
  ...
  const onSubmit = async (data: FormValues) => {
    try {
      ...
      if (response.success) {
        ...
        await Swal.fire({
          title: "Error",
          text: response.message || "Failed to create job posting",
          icon: "error",
        });
      }
    } catch (error) {
