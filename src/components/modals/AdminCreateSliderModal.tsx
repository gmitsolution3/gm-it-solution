// components/modals/AdminCreateSliderModal.tsx
"use client";
...
interface AdminCreateSliderModalProps {
  isModalOpen: boolean;
  setIsModalOpen: (open: boolean) => void;
  onSuccess?: () => void;
}

export default function AdminCreateSliderModal({
  isModalOpen,
  setIsModalOpen,
  onSuccess,
}: AdminCreateSliderModalProps) {
