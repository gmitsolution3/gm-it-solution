// components/modals/AdminCreateServiceModal.tsx
"use client";
...
interface AdminCreateServiceModalProps {
  isModalOpen: boolean;
  setIsModalOpen: (open: boolean) => void;
  onSuccess?: () => void;
}

export default function AdminCreateServiceModal({
  isModalOpen,
  setIsModalOpen,
  onSuccess,
}: AdminCreateServiceModalProps) {
